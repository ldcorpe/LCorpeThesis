...
\centering
 \subfloat[]{
\includegraphics[width=0.55\textwidth]{catFigures/stack_scaled_resultFlat_mc_cat0_noratio.pdf}
\label{fig:cat:diphobdt_a}
}
\\
 \subfloat[]{
\includegraphics[width=0.60\textwidth]{catFigures/BDTTransfSyst_TrasfBDT_lin_1sigma_shiftPlusTransf_new_noratio.pdf}
