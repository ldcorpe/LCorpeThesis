...
\hline
 ...
 The mass $m$ and electric charge $q$ are indicated for each particle\quad\cite{PDGBooklet}. The uncertainties on the masses have been omitted, although some are large.} 
...
\hline
 ...
 The mediator particle of each force is indicated along with its measured mass, where the uncertainties have been omitted\quad\cite{Thomson:2013zua,PDGBooklet}.}
\label{tab:th:bosons}
  \end{table}
