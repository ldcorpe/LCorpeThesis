...
\acro{ggH}{gluon-gluon fusion Higgs boson production}
...
\acro{ttH}{top quark fusion and associated Higgs boson production}
\acro{UES}{unclustered energy scale}
\acro{UE}{underlying event}
\acro{VBF}{vector boson fusion}
\acro{VEV}{vacuum expectation value}
\acro{VH}{vector boson associated Higgs boson production}
\acro{VPTs}{vacuum photon-triodes}
\acro{WH}{\PW boson associated Higgs boson production}
\acro{WLCG}{Worldwide LHC Computing Grid}
\acro{WV}{wrong vertex}
\acro{ZH}{\PZ boson associated Higgs boson production}
\end{acronym}
