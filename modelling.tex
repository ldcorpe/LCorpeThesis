...
%. In both cases the \RV and \WV components have been summed according to their relative event count. %The agreement between the distribution and the parametrisation when the simpler paramertisation can be seen from the $\chi^2/\text{NDOF}$values.
\fi
...
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/DCBpG/LI/LCtest_ggh_UntaggedTag_0_rv_125.pdf} 
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/DCBpG/LI/LCtest_ggh_UntaggedTag_1_rv_125.pdf} \\
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/DCBpG/LI/LCtest_ggh_UntaggedTag_2_rv_125.pdf} 
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/DCBpG/LI/LCtest_ggh_UntaggedTag_3_rv_125.pdf} 
}}\\
...
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/nGaus/LI/LCtest_ggh_UntaggedTag_0_rv_125.pdf} 
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/nGaus/LI/LCtest_ggh_UntaggedTag_1_rv_125.pdf}\\ 
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/nGaus/LI/LCtest_ggh_UntaggedTag_2_rv_125.pdf} 
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/nGaus/LI/LCtest_ggh_UntaggedTag_3_rv_125.pdf} 
}}
...
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/DCBpG/LI/LCtest_ggh_UntaggedTag_0_wv_125.pdf} 
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/DCBpG/LI/LCtest_ggh_UntaggedTag_1_wv_125.pdf} \\
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/DCBpG/LI/LCtest_ggh_UntaggedTag_2_wv_125.pdf} 
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/DCBpG/LI/LCtest_ggh_UntaggedTag_3_wv_125.pdf} 
}}\\
...
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/nGaus/LI/LCtest_ggh_UntaggedTag_0_wv_125.pdf} 
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/nGaus/LI/LCtest_ggh_UntaggedTag_1_wv_125.pdf}\\ 
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/nGaus/LI/LCtest_ggh_UntaggedTag_2_wv_125.pdf} 
\includegraphics[width=0.5\textwidth]{modellingFigures/\whichFig/nGaus/LI/LCtest_ggh_UntaggedTag_3_wv_125.pdf} 
}}
